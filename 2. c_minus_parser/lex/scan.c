...
/*                                                  */
/* @Author JeongMin Cha, A student at Hanyang Univ. */
/****************************************************/
...
typedef enum {
  START, INNUM, INID, 
  INTOCOMMENT, INCOMMENT, OUTOFCOMMENT, 
  INASSIGN, INSE, INLE, INNEQ, DONE
} StateType;
...
{  /* index for storing into tokenString */
  ...
  while(state != DONE)
  {
	...
	currentToken = ASSIGN;
      ...
      break;/* End of case 'staet == INASSIGN' */
    case INLE: 
      if(c == '=')
      {	save = FALSE;
	state = DONE;
	...
	ungetNextChar();
      ...
      break;/* End of case 'staet == INTOCOMMENT' */
    case INCOMMENT:
      save = FALSE;
      if(c == '*')
	state = OUTOFCOMMENT;
      break;/* End of case 'staet == INCOMMENT' */
    case OUTOFCOMMENT:
      if(c == '/')
      {	state = DONE;
	currentToken = COMMENT;
        ...
        state = INCOMMENT;
      break; /* End of case 'staet == OUTOFCOMMENT' */
    case INNUM:
      if(!isdigit(c))
      {	ungetNextChar();
	save = FALSE;
